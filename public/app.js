    ...
    return `
        <div class="animate-fade-in h-full flex flex-col">
            ...
            const getBudgetStatus = (amount, recommendedPercent) => {
                ...
                const threshold90 = recommended * 0.9;
            ...
            const rentStatus = getBudgetStatus(rent, 0.30);
            const utilitiesStatus = getBudgetStatus(utilities, 0.07);
            const transportStatus = getBudgetStatus(transport, 0.10);
            const loanStatus = getBudgetStatus(loanCost, 0.15);

            return `
                        <div class="flex justify-between items-center">
                            <div class="flex items-center gap-2">
                                <div class="flex flex-col items-center">
                                    <span class="text-${rentStatus.color}-400 text-lg leading-none">${rentStatus.icon}</span>
                                    <span class="text-[9px] text-${rentStatus.color}-400 leading-tight">${rentStatus.label}</span>
                                </div>
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex items-center gap-2">
                                <div class="flex flex-col items-center">
                                    <span class="text-${utilitiesStatus.color}-400 text-lg leading-none">${utilitiesStatus.icon}</span>
                                    <span class="text-[9px] text-${utilitiesStatus.color}-400 leading-tight">${utilitiesStatus.label}</span>
                                </div>
                        ...
                        <div class="flex justify-between items-center">
                            <div class="flex items-center gap-2">
                                <div class="flex flex-col items-center">
                                    <span class="text-${loanStatus.color}-400 text-lg leading-none">${loanStatus.icon}</span>
                                    <span class="text-[9px] text-${loanStatus.color}-400 leading-tight">${loanStatus.label}</span>
                                </div>
